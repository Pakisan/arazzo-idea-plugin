...
object YamlFileXPath: PsiFileXPath<YAMLFile>() {
    ...
    override fun findText(arazzoSpecification: YAMLFile?, psiXPath: String, partialMatch: Boolean): List<String> {
    ...
    override fun findPsi(arazzoSpecification: YAMLFile?, psiXPath: String, partialMatch: Boolean): List<PsiElement> {
        ...
        var elements: List<PsiElement> = arazzoSpecification.documents.flatMap { it.yamlElements }
