 ...
 * @since 1.0.0
 */
abstract class PsiFileXPath<ArazzoSpecification: PsiFile> {
     ...
     *
     * @param arazzoSpecification [PsiFile] to inspect.
     ...
     */
    abstract fun findText(arazzoSpecification: ArazzoSpecification?, psiXPath: String, partialMatch: Boolean = false): List<String>
     ...
     */
    abstract fun findPsi(arazzoSpecification: ArazzoSpecification?, psiXPath: String, partialMatch: Boolean = false): List<PsiElement>
